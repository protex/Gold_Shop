...
type 3.X.X\shop\shop.js 3.x.x\mainFrame\mainFrame.js 3.X.X\shop\shopPage.js 3.X.X\shop\buyPage.js 3.X.X\shop\infoPage.js 3.X.X\shop\profilePage.js 3.x.x\shop\infoPackagePage.js 3.X.X\shop\givePage.js 3.X.X\api\api.js 3.x.x\shop\removePage.js 3.x.x\shop\buyPackagePage.js 3.x.x\shop\addPage.js 3.X.X\misc\misc.js >> gShop.dev.js
